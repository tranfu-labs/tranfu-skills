...
def render_research(report: dict, palette_name: str) -> str:
    ...
    dense = len(c["items"]) > 8
    canvas_padding = "24px 64px 24px" if dense else ("24px 64px 22px" if compact else "24px 64px 28px")
    masthead_height = "108px" if dense else ("116px" if compact else "126px")
    cover_size = "46px" if dense else ("47px" if compact else "50px")
    yellow_margin = "-6px 0 10px 6px" if dense else ("-6px 0 10px 6px" if compact else "-6px 0 18px 6px")
    yellow_height = "15px" if dense else "16px"
    story_padding = "12px 0 13px" if dense else ("11px 0 12px" if compact else "22px 0 22px")
    story_gap = "19px" if dense else ("18px" if compact else "20px")
    rank_size = "43px" if dense else ("42px" if compact else "45px")
    story_title_size = "26px" if dense else ("25px" if compact else "29px")
    story_title_margin = "0 0 7px" if dense else ("0 0 6px" if compact else "0 0 10px")
    story_body_size = "16.2px" if dense else ("15.5px" if compact else "18px")
    story_body_line_height = "1.3" if dense else ("1.27" if compact else "1.36")
    footer_margin = "14px" if dense else ("10px" if compact else "18px")
    quote_size = "22px" if dense else ("22px" if compact else "26px")
    quote_by_size = "16px" if dense else ("16px" if compact else "18px")
    qr_html = (
