...
- ❌ 不要直接写 PRD，除非用户另行明确要求且已经完成立项判断。
- ❌ 不要把普通工具包装成战略产品，例如低配排版器、低配待办页。
- ❌ 不要因为"能开发出来"就建议立项，必须看到真实问题和 TranFu 能力沉淀。
- ❌ 不要输出长篇产品分析报告，默认一屏以内。
- ❌ 不要一次追问 8 个问题，信息不足时只问最关键的 2-3 个。
- ❌ 不要给出模糊结论，必须在三档结论中选择一个。
- ❌ 不要建议做会影响 TranFu 品牌形象的低质 Demo。
