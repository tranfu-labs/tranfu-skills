...
function makeResult(input, output, inputBytes, outputBytes, format, metadata, outputInfo) {
...
async function processFile(sharp, inputPath, options) {
  ...
  if (options.output && output === input) {
    throw new CliError("Output path must differ from the input; use --replace to authorize replacement");
  }
